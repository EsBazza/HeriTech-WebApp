        ...
        const sampleMessages: MessageItem[] = [
          {
            ...
            receiver: { id: currentUserId, fullName: user?.fullName || "Danilo Cruz", role: "artisan", workshopName: "Cordillera Cooperative" },
          },
          {
            id: "msg_02",
            senderId: currentUserId,
            receiverId: "usr_lgu_04",
            content: translateSync("Hello Engr. Santos! I'll be arriving tomorrow at 10:00 AM with our cooperative transport to scan the QR token."),
            contextType: "batch_reservation",
            contextId: "HT-2026-0102",
            isSystem: false,
          ...
          },
          {
            ...
            receiverId: currentUserId,
            content: translateSync("Order #HT-ORD-519 completed for 'Cordillera Botanical Loom Wall Tapestry'. 70% direct escrow payout ($31.50) sent to your cooperative. Thank you for diverting 1.5 kg of festival waste."),
            contextType: "order",
